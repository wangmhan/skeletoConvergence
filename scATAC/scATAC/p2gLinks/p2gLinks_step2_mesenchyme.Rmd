...
proj <- loadArchRProject(path=paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/limb_mesenchyme_gListStage_p2glinks"))

my.atac=readRDS("~/scATAC/integration/limb_atac_intgtFine010721.rds")
my.meta=readRDS("/scicore/home/tschoppp/wang0007/scATAC/integration/limb_atac_integrated010721_meta.rds")
my.atac=AddMetaData(my.atac,metadata = my.meta[rownames(my.atac@meta.data),"fine"],col.name = "fine")
...
mtx.fl_rna = readRDS(paste0("~/scRNA/clustering/subset_limb.rds"))
...
saveRDS(p,paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/limb_mesenchyme_p2glinks_ArchR.rds"))
saveArchRProject(ArchRProj = proj, outputDirectory = paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/limb_mesenchyme_p2glinks_ArchR"), load = FALSE)
...
#################
## read in ArchR project & signac project
proj <- loadArchRProject(path=paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/nasal_mesenchyme_gListStage_p2glinks"))

my.atac=readRDS("~/scATAC/integration/nasal_atac_intgtFine010721.rds")
...
#################
## integrate with scRNA
mtx.fl_rna = readRDS(paste0("~/scRNA/clustering/subset_nasal.rds"))
...
saveRDS(p,paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/nasal_mesenchyme_p2glinks_ArchR.rds"))
saveArchRProject(ArchRProj = proj, outputDirectory = paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/nasal_mesenchyme_p2glinks_ArchR"), load = FALSE)
...
#################
## read in ArchR project & signac project
proj <- loadArchRProject(path=paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/somite_mesenchyme_gListStage_p2glinks"))

my.atac=readRDS("~/scATAC/integration/somite_atac_intgtFine010721.rds")
...
#################
## integrate with scRNA
mtx.fl_rna = readRDS(paste0("~/scRNA/clustering/subset_somite.rds"))
...
saveRDS(p,paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/somite_mesenchyme_p2glinks_ArchR.rds"))
saveArchRProject(ArchRProj = proj, outputDirectory = paste0("/scicore/home/tschoppp/wang0007/scATAC/identifyRE/somite_mesenchyme_p2glinks_ArchR"), load = FALSE)
