...
use the same peak list for fig2.G:?top 1000 DAPs for all cell types in broad cluster
...
#save_pheatmap_pdf(correlation2$plot,"~/figure_drafts/corHeatmap_scatac_geneset1ActypePearson_v2.pdf", width=12, height=8)
```
